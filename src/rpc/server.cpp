...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VALUTO features */
        {"valuto", "listmasternodes", &listmasternodes, true, true, false},
        {"valuto", "getmasternodecount", &getmasternodecount, true, true, false},
        {"valuto", "masternodeconnect", &masternodeconnect, true, true, false},
        {"valuto", "masternodecurrent", &masternodecurrent, true, true, false},
        {"valuto", "masternodedebug", &masternodedebug, true, true, false},
        {"valuto", "startmasternode", &startmasternode, true, true, false},
        {"valuto", "createmasternodekey", &createmasternodekey, true, true, false},
        {"valuto", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"valuto", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"valuto", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"valuto", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"valuto", "getmasternodescores", &getmasternodescores, true, true, false},
        {"valuto", "mnsync", &mnsync, true, true, false},
        {"valuto", "spork", &spork, true, true, false},
        {"valuto", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use valutod, or the -server option to valuto-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> valuto-cli " + methodname + " " + args + "\n";
}
