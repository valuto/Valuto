...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("VALUTO Core valuto-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  valuto-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded VALUTO transaction") + "\n" +
                               "  valuto-tx [options] -create [commands]   " + _("Create hex-encoded VALUTO transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded VALUTO transaction
