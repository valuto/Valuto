 ...
 * VALUTO system. There are three: the main network on which people trade goods
...
public:
    ...
    const std::vector<unsigned char>& vALUTODevKey() const { return vVALUTODevKey; }
    const std::vector<unsigned char>& vALUTOFundKey() const { return vVALUTOFundKey; }
...
protected:
    ...
    std::vector<unsigned char> vVALUTODevKey;
    std::vector<unsigned char> vVALUTOFundKey;
    int nDevFee;
    int nFundFee;
    int nDefaultPort;
