...
QFontDatabase::addApplicationFont(":/fonts/valuto_font");

QString windowTitle = tr("VALUTO Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and VALUTO: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VALUTO Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about VALUTO Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VALUTO Wallet"));
    ...
    openAction->setStatusTip(tr("Open a VALUTO: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the VALUTO Wallet help message to get a list with possible VALUTO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VALUTO Wallet client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("VALUTO Wallet"); // default title
