...
/** Utility functions used by the VALUTO Qt UI.
 */
namespace GUIUtil
{
...
// Render VALUTO addresses in monospace font
...
// Parse "valuto:" URI into recipient object, return true on successful parsing
