...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(VLU);
   // unitlist.append(mVALUTO);
   // unitlist.append(uVALUTO);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case VLU:
            return QString("VLU");
        case mVLU:
            return QString("Milli-VLU (1 / 1" THIN_SP_UTF8 "000)");
        case uVLU:
            return QString("Micro-VLU (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case VLU:
            return QString("TestVLUs");
        case mVLU:
            return QString("Milli-TestVLUs (1 / 1" THIN_SP_UTF8 "000)");
        case uVLU:
            return QString("Micro-TestVLUs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
