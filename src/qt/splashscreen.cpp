...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("VALUTO Wallet");
    ...
    QString copyrightTextVALUTO = QChar(0xA9) + QString(" 2017-2020 ").arg(COPYRIGHT_YEAR) + QString(tr("The VALUTO Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextVALUTO);
