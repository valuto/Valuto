...
RESOURCES += src/qt/valuto.qrc src/qt/valuto_locale.qrc

TRANSLATIONS += src/qt/locale/valuto_bg.ts \
                src/qt/locale/valuto_de.ts \
                src/qt/locale/valuto_en.ts \
                src/qt/locale/valuto_es.ts \
                src/qt/locale/valuto_fi.ts \
                src/qt/locale/valuto_fr.ts \
                src/qt/locale/valuto_it.ts \
                src/qt/locale/valuto_ja.ts \
                src/qt/locale/valuto_pl.ts \
                src/qt/locale/valuto_pt.ts \
                src/qt/locale/valuto_ru.ts \
                src/qt/locale/valuto_sk.ts \
                src/qt/locale/valuto_sv.ts \
                src/qt/locale/valuto_vi.ts \
                src/qt/locale/valuto_zh_CN.ts \
                src/qt/locale/valuto_zh_TW.ts
