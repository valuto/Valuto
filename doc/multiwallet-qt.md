...
In order to support loading of multiple wallets in valuto-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is valuto.cpp.
...
Changes to valuto.cpp
----------------------
valuto.cpp is the entry point into valuto-qt, and as such, will require some minor modifications to provide hooks for
