Contributing to VALUTO Core
============================

The VALUTO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VALUTO Core project, and is not to be
confused with overall VALUTO Network Protocol consensus changes.

Whether a pull request is merged into VALUTO Core rests with the project merge
...
Patches that change VALUTO consensus rules are considerably more involved than
...
Where a patch set proposes to change the VALUTO consensus, it must have been
...
The project leader is the release manager for each VALUTO Core release.
