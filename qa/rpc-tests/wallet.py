...
#   c) node1 mines 32 blocks, so now node 0 has 60001valuto, node 1 has 4250valuto, node2 has none.
#   d) node0 sends 601 valuto to node2, in two transactions (301 valuto, then 300 valuto).
